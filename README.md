...
####The CVE-2020-14979 vulnerability arose because WinRing0 exposed a device object with a NULL DACL and undocumented IOCTLs that let any user open \Device\PhysicalMemory and read/write arbitrary addresses.
...
Because neither a raw physical-memory IOCTL is exposed nor is there a loosenening of the ACL on your device object, you’re not vulnerable to the “map any physical page” escalation CVE-2020-14979 describes.